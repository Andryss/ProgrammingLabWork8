...
public class Data extends ListResourceBundle {
    ...
    private final Object[][] contents = new Object[][] {
            ...
            {"Are you sure to delete user? (all your elements will be deleted)", "Are you sure to delete user? (all your elements will be deleted)"},
            {"Are you really sure?", "Are you really sure?"},
            {"Are you REALLY sure to DELETE USER? (ALL your elements WILL BE DELETED)", "Are you REALLY sure to DELETE USER? (ALL your elements WILL BE DELETED)"},
            {"Are you really really really sure?", "Are you really really really sure?"},
            {"ARE YOU REALLY REALLY REALLY SURE TO DELETE USER? (ALL YOUR ELEMENTS WILL BE DELETED)", "ARE YOU REALLY REALLY REALLY SURE TO DELETE USER? (ALL YOUR ELEMENTS WILL BE DELETED)"},
            {"Settings", "Settings"},
            {"Language", "Language"},
            {"Theme", "Theme"},
            {"Default", "Default"},
